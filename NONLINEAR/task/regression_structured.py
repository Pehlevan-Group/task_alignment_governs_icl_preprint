...
class fulltasksampler:
    def __init__(self, d, l, n, rho, Ctask, single_index_power=1) -> None:
        self.d = d # DIMENSION
        ...
        self.single_index_power = single_index_power
...
class finitetasksampler:
    def __init__(self, d, l, n, k, rho, Ctask, single_index_power=1) -> None:
        self.d = d # DIMENSION
        self.l = l # CONTEXT LENGTH
        self.n = n # NUMBER OF CONTEXTS
    ...
    def __next__(self):
        ...
        ys = (xs @ ws)**self.single_index_power + self.rng.normal(loc=0, scale = np.sqrt(self.rho), size=(self.n, context_length, 1))
