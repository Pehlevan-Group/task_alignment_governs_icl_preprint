...
from reduced_model_codebase.theory import complexity_class_covariance
...
# This is a matrix with trace = d, isotropic on its first half entries, 0 on the next half. 
